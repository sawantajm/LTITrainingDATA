...
namespace FinalProject.Controllers
{
    [ApiController]
    [Route("java")]
    public class ConductExamController : Controller
    {
         private readonly OnlineExamContext db;
              ...
              { 
                //for Level1
                  var que = from q in db.QuestionDetails
                            ...
                            select new {QuestionNo=q.QuestionNumber, Question=q.Question,Option1=q.Option1,
                                Option2=q.Option2,Option3=q.Option3,Option4=q.Option4,Level=l.LevelName};
          ...
          public IActionResult conductExam2()
          {
              ...
              { 
                  var que = from q in db.QuestionDetails
                            ...
                            select new { QuestionNo = q.QuestionNumber, Question = q.Question,
                                Option1 = q.Option1, Option2 = q.Option2, Option3 = q.Option3, Option4 = q.Option4, Level = l.LevelName };
          ...
          public IActionResult saveResponces(string student_response, int? question_id,QuestionDetail questionDetail)
          {
              ...
              {   
                  if(respo!=null)
                  {
                      respo.Student_response = student_response;
                      db.SaveChanges();
